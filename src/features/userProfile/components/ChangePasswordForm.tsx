...
export const ChangePasswordForm = () => {
	...
	const [updatePassword, { isSuccess, isError, error }] = useUpdateUserPasswordMutation();
	...
	return (
		<div>
			<Form
				...
				onSubmit={async (values: UpdatePasswordRequest, actions: any) => {
					await updatePassword(values);
					actions.setSubmitting(false);
				}}
				schema={schema}
			>
				<InputField type="password" label="Old Password" name="oldPassword" />
