...
export const InputField = (
  props: InputFieldProps & FieldHookConfig<string>
) => {
  ...
  return (
    <FieldWrapper error={error} touched={touched} label={label} width={width}>
      <input
        ...
        {...field}
        className={clsx(
          "flex-1 min-w-0 block w-full px-3 py-2 rounded-md focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300",
          error && touched
